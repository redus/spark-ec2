...
case "$HADOOP_MAJOR_VERSION" in
  1)
    ...
    cp /home/ec2-user/hadoop-native/* /home/ec2-user/persistent-hdfs/lib/native/
    ;;
  2)
    ...
    rm -rf /home/ec2-user/persistent-hdfs/etc/hadoop/
    ln -s /home/ec2-user/persistent-hdfs/conf /home/ec2-user/persistent-hdfs/etc/hadoop
    cp /home/ec2-user/hadoop-native/* /home/ec2-user/persistent-hdfs/lib/native/
    ;;
  yarn)
...
/home/ec2-user/spark-ec2/copy-dir /home/ec2-user/persistent-hdfs
