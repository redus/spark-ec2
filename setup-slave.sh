...
bash /home/ec2-user/spark-ec2/resolve-hostname.sh
...
setup_ebs_volume /dev/xdvb /data
...
/home/ec2-user/spark-ec2/create-swap.sh $SWAP_MB
...
cat /home/ec2-user/spark-ec2/github.hostkey >> /home/ec2-user/.ssh/known_hosts
